    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="row justify-content-center">
                <input class="barre-recherche site-search" type="search" id="searchuser" name="searchuser"
        ...
        <div class="row">
           <label for="userList"> Utilisateur : </label>
            <select id="userList" class="" name="userList" content-type="choices" trigger="true">
            </select>
        </div>
...
<script src="js/jsForPage/adminUser.js"></script>
